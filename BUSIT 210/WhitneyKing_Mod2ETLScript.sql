...
INSERT INTO [DWAdventureWorks_Basics].[dbo].[DimCustomers]
	( [CustomerID], [CustomerFullName], [CustomerCityName], [CustomerStateProvinceName], 
...
INSERT INTO [DWAdventureWorks_Basics].[dbo].[DimProducts]
	( [ProductID], [ProductName], [StandardListPrice], [ProductSubCategoryID], [ProductSubCategoryName], 
...
WHILE @DateInProcess <= @EndDate
 ...
 VALUES (
  ...
  , DateName(weekday, @DateInProcess ) + ', ' + DateName(mm, @DateInProcess ) + ' ' +  Convert(nVarchar(50), 
    @DateInProcess, 110) -- [DateKey] = 20050101 to 20101231
